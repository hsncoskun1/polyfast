...
const allPass = (zaman = '3:15', fiyat = '83', delta = '$55'): RuleSpecContract[] => [
  ...
  { label: 'Spread', live_value: '—',    threshold_text: 'KAPALI',  state: 'disabled' },
