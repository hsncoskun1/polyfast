...
export const MOCK_POSITIONS: PositionSummary[] = [
  ...
  // 1) BTC — yeni fill (pozisyon yeni acildi)
  {
    ...
    pnl_amount: '-1000.00$',
    pnl_tone: 'loss',
    live: { side: 'UP', entry: '0.6800', live: '0.6800', delta_text: '0.0000' },
  ...
  // 2) ETH — TP yaklasiyor
  {
    ...
    pnl_amount: '+0.31$',
    pnl_tone: 'profit',
    live: { side: 'UP', entry: '0.8300', live: '0.8560', delta_text: '+0.0260' },
  ...
  // 3) AVAX — TP tetiklendi
  {
    ...
    pnl_amount: '+1.34$',
    pnl_tone: 'profit',
    live: { side: 'UP', entry: '0.7800', live: '0.8850', delta_text: '+0.1050' },
  ...
  // 4) SOL — SL yaklasiyor
  {
    ...
    pnl_amount: '-0.18$',
    pnl_tone: 'loss',
    live: { side: 'DOWN', entry: '0.5500', live: '0.5280', delta_text: '-0.0220' },
  ...
  // 5) DOGE — SL tetiklendi
  {
    ...
    pnl_amount: '-120.00$',
    pnl_tone: 'loss',
    live: { side: 'UP', entry: '0.7100', live: '0.5600', delta_text: '-0.1500' },
  ...
  // 6) LINK — FS countdown (zorunlu kapatma 8s)
  {
    ...
    pnl_amount: '-0.04$',
    pnl_tone: 'loss',
    live: { side: 'DOWN', entry: '0.6200', live: '0.6420', delta_text: '+0.0220' },
  ...
  // 7) BNB — Force sell ile kapandi
  {
    ...
    pnl_amount: '-0.06$',
    pnl_tone: 'loss',
    live: { side: 'UP', entry: '0.5600', live: '0.5000', delta_text: '-0.0600' },
